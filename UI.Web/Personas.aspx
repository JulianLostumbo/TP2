...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="formPanel" Visible="false" runat="server" Width="737px" Class="form" Height="630px">
        <div style="text-align: left; height: 530px;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="IDTextBox" ErrorMessage="El ID no puede estar vacío" ForeColor="Red">*</asp:RequiredFieldValidator>
            <br />
