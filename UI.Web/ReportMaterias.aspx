...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="UI.Web.DataSetMateriasTableAdapters.materiasTableAdapter"></asp:ObjectDataSource>
</asp:Content>
